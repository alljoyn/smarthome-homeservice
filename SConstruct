...
vars.Add('SERVICES', 'AllJoyn services libraries to build (comma separated list): about,config,controlpanel,notification,onboarding,audio,SmartHome','about')
...
if services.intersection(['config', 'controlpanel', 'notification', 'onboarding', 'audio', 'SmartGatewayService']):
    ...
    if 'SmartGatewayService' in services:
        env.SConscript(['../../services/SmartHome/SConscript'])
